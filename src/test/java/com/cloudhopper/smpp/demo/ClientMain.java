...
//        config0.setPassword("KMI@2020y");
        ...
        try {
            ...
            String text160 = "test google.com";
            ...
            submit0.setSourceAddress(new Address((byte)0x03, (byte)0x00, "KMI LTD"));
            submit0.setDestAddress(new Address((byte)0x01, (byte)0x01, "2348064730444"));
            submit0.setShortMessage(text160.getBytes());
